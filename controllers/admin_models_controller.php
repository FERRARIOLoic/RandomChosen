...
$pageTitle = 'Administration des modèles';

//------------- REQUIRED ---------//
require_once __DIR__ . '/../models/Brands.php';
require_once __DIR__ . '/../models/Categories.php';
require_once __DIR__ . '/../models/Networks.php';
require_once __DIR__ . '/../models/Fingerprints.php';
...
$networks_list = Network::getAll();
$fingerprints_list = Fingerprint::getAll();
...
//------------- VIEWS ---------//
include(__DIR__ . '/../views/admin/admin_models.php');
