                ...
                <div class="col-12 py-4 mb-4">
                    ...
                    <form class="row" method="POST" action="inscription.html">
                        ...
                        <div class=" col-12 form-floating mb-4">
                            <input type="text" autocomplete="registration_number" class="form-control <?= isset($errors['global']) ? 'is-invalid' : '' ?>" id="registration_number" name="registration_number" required placeholder="Matricule" />
                            <label for="registration_number" class="form-label px-4 boxContactTitle">Matricule<span class='text-danger fw-bold'>*</span></label>
                            <div class="<?= isset($errors['registration_number']) ? 'errorForm errorBoxDown' : ''; ?>"><?= $errors['registration_number'] ?? '' ?></div>
                        </div>
