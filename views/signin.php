<main class='container-fluid mb-5'>
    <div class="row titlePage">
        <!-- <div class="col-12 text-center fs-1 titleSite fw-bold text_blue"><?= $page_title; ?></div> -->
    </div>
    ...
    <section class="forms-section">
        <div class="forms">
            ...
            <div class="form-wrapper <?= (!empty($errors['global']) and $errors['global'] == 'no_account') ? '' : 'is-active'; ?>">
                ...
                <form class="form form-login <?= (!empty($errors['global']) and ($errors['global'] == 'account_deactivated')) ? 'div_is_invalid' : ''; ?> shadow" action="connexion_utilisateur.html" method="post">
                    <fieldset>
                    ...
                    <fieldset class="col-12 pt-2">
                        <a href="mot_de_passe_perdu.html" class="fs-8 fst-italic text-white fs-7">Identifiant / Mot de passe perdu ?</a>
                    </fieldset>
                </form>
            ...
            <div class="form-wrapper <?= (!empty($errors['global']) and $errors['global'] == 'no_account') ? 'is-active' : ''; ?>">
                ...
                <form class="form form-signup bg_green shadow text-white" action="connexion_utilisateur.html" method="post">
